...
if ($result) {
    echo "<script>alert('Data berhasil disimpan'); window.location = 'inputhasilproduksi.php'</script>";
} else {
    echo "<script>alert('Data gagal disimpan'); window.location = 'inputhasilproduksi.php'</script>";
}